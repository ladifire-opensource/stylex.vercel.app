  ...
  return (
    <div className={stylex(styles.container)}>
      ...
      <main className={stylex(styles.main)}>
          <img src="/logo-black.png" alt="Vercel Logo" className={stylex(styles.topLogo)} />
        <h1 className={stylex(styles.title)}>
          Write CSS-in-JS with atomic!
        </h1>
      ...
      <footer className={stylex(styles.footer)}>
        <span className={stylex(styles.footerContent)}>
          ...
          <img src="/logo-black.png" alt="Stylex Logo" className={stylex(styles.logo)} />
        </span>
      </footer>
    </div>
  )
